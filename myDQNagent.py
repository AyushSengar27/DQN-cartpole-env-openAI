...
class DQNAgent:
    ...
    hidden_units: list = field(default_factory=lambda: [128, 128])
    ...
    def evaluate(self, eval_env, n_eval_episodes=10, max_episode_length=150):
        returns = []  
...
def run():
    ...
    agent = DQNAgent(env.observation_space, env.action_space, lr=0.001, discount_factor=0.95, eps_start=0.01, hidden_units=[128, 128], enable_target_network=False, enable_experience_replay=True, replay_buffer_size=10000, batch_size=32)
...
def DQN_learning(num_epochs,max_epoch_env_steps,eval_interval,n_eval_episodes,lr=0.001,discount_factor=0.95,eps_start=0.01,enable_target_network=False, enable_experience_replay=True,mode='epsilon-greedy',temperature=0.1):
        mode=mode
        ...
        env = gym.make('CartPole-v1')
        eval_env = gym.make('CartPole-v1')  # Separate environment for evaluation
        agent = DQNAgent(env.observation_space, env.action_space, lr=lr, discount_factor=discount_factor, eps_start=eps_start, hidden_units=[128, 128], enable_target_network=enable_target_network, enable_experience_replay=enable_experience_replay, replay_buffer_size=10000, batch_size=32,temperature=temperature)
...
def test():
    ...
    eval_returns, eval_timesteps = DQN_learning(num_epochs,max_epoch_env_steps,eval_interval,n_eval_episodes,lr=0.001,discount_factor=0.95,eps_start=0.01,enable_target_network=enable_target_network, enable_experience_replay=enable_experience_replay,mode='epsilon-greedy')
